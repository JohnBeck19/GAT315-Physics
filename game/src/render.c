#include "render.h"
#include "raymath.h" // Include for Vector2 type
 ...
 *
 * world: The world coordinates to convert.
 *
...
/*
 * Function: ConvertWorldToPixel
 * ------------------------------
 * Converts world units to pixel units.
 *
 * world: The value in world units to convert.
 *
 * returns: The value in pixel units.
 */
